				...
				<div class="main-content">
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle" style="font-weight:600">Add Patient</h1>
								</div>
							</div>
						</section>
												...
												<div class="panel-body">
													<form role="form" name="" method="post">
														...
														<div class="form-group">
															...
															<input type="text" name="patcontact" class="form-control" placeholder="Enter Patient Contact Number" required="true" maxlength="10" pattern="[0-9]+">
														</div>
														<div class="form-group">
															<label for="fess">
																Patient Email
															</label>
															<input type="email" id="patemail" name="patemail" class="form-control" placeholder="Enter Patient Email" required="true" onBlur="userAvailability()">
