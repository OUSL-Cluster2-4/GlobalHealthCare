...
if (strlen($_SESSION['id'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $temp = $_POST['temp'];
    $pres = $_POST['pres'];
    $query .= mysqli_query($con, "insert   medicalhistory(PatientID,BloodPressure,BloodSugar,Weight,Temperature,Prescription)value('$vid','$bp','$bs','$weight','$temp','$pres')");
    if ($query) {
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h3 class="modal-title" id="exampleModalLabel">Add Medical History</h3>
