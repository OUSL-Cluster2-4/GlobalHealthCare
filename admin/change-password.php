...
if (strlen($_SESSION['id'] == 0)) {
	...
	if (isset($_POST['submit'])) {
		...
		if ($num > 0) {
			$npass = $_POST['npass'];
			$con = mysqli_query($con, "update admin set password='$npass' where username='$uname'");
												...
												<div class="panel-body">
													...
													<form role="form" name="chngpwd" method="post" onSubmit="return valid();">
														...
														<div class="form-group">
															...
															<input type="password" name="cfpass" class="form-control" placeholder="Enter Confirm Password">
														</div>
